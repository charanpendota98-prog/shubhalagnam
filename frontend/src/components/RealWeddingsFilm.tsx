...
const SHOTS: WeddingStory[] = [
  ...
  {
    src: "/promo/story-3.jpg",
    te: "అనూష & వంశీ",
    en: "Anusha & Vamsi",
    tag: "Kapu",
    cityTe: "తిరుపతి & నెల్లూరు",
    cityEn: "Tirupati & Nellore",
    ...
    storyTe: "ఇరు కుటుంబాల సమక్షంలో తిరుమల సన్నిధిలో అంగరంగ వైభవంగా జరిగిన శుభ వివాహం.",
    storyEn: "A magnificent traditional Telugu wedding celebrated at Tirumala with both families' blessings.",
  },
  {
    src: "/promo/story-4.jpg",
    te: "మౌనిక & సాయి",
    en: "Mounika & Sai",
    tag: "Arya Vysya",
    cityTe: "వరంగల్ & కరీంనగర్",
    cityEn: "Warangal & Karimnagar",
    ...
    storyTe: "ఇరు కుటుంబాల ఆశీస్సులతో వేద మంత్రోచ్ఛారణల మధ్య జరిగిన పవిత్ర పాణిగ్రహణం.",
    storyEn: "Sacred wedding ceremony performed with Vedic rituals and family blessings.",
  },
];
