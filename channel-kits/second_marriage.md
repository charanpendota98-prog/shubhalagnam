...
- **Key:** `second_marriage`  •  **Tier:** L4_SPECIAL  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_second` (already taken? → @tsap_second, @manavivaha_remarriage)
- **Link:** https://t.me/manavivaha_second
- **Hashtags:** #SecondMarriage #Remarriage #Respect
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/second_marriage.png`
...
```
💍 Second Marriage — రెండో పెళ్లి. ఈ కేటగిరీ ప్రత్యేక profiles మాత్రమే — వేరే ఎక్కడా దొరకవు. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
```
📜 *CHANNEL RULES — 💍 Second Marriage | రెండో పెళ్లి*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_second
...
```bash
python setup_channels.py --apply --key second_marriage
```
