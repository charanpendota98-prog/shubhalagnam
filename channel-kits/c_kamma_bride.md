...
- **Key:** `c_kamma_bride`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** LIVE ✅
...
- **DP image:** `/home/user/shubhalagnam/backend/channel_assets/c_kamma_bride.png`
...
```
కమ్మ — Kamma (Brides). Sub-castes: Kamma • Chowdary • Choudary. నిజమైన profiles, 3 requests FREE, ₹99లో 5. Register FREE: manavivaha.in | Telegram: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #Kamma #Bride #TS #AP/channels
...
```
📜 *CHANNEL RULES — 👰 Kamma Brides | కమ్మ వధువులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_kamma_bride
...
```bash
python setup_channels.py --apply --key c_kamma_bride
```
