...
- **Key:** `differently_abled`  •  **Tier:** L4_SPECIAL  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_able` (already taken? → @tsap_handicapped, @manavivaha_differentlyabled)
- **Link:** https://t.me/manavivaha_able
- **Hashtags:** #DifferentlyAbled #SpecialCare
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/differently_abled.png`
...
```
♿ Differently-Abled — ప్రత్యేక సామర్థ్యం. ఈ కేటగిరీ ప్రత్యేక profiles మాత్రమే — వేరే ఎక్కడా దొరకవు. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #DifferentlyAbled #SpecialCare/channels
...
```
📜 *CHANNEL RULES — ♿ Differently-Abled | ప్రత్యేక సామర్థ్యం*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_able
...
```bash
python setup_channels.py --apply --key differently_abled
```
