...
- **Key:** `fraud_alerts`  •  **Tier:** L4_SPECIAL  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_alerts` (already taken? → @tsap_alerts)
- **Link:** https://t.me/manavivaha_alerts
- **Hashtags:** #FraudAlert #StaySafe
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/fraud_alerts.png`
...
```
🚨 Fraud Alerts — మోసం జాగ్రత్త. ఈ కేటగిరీ ప్రత్యేక profiles మాత్రమే — వేరే ఎక్కడా దొరకవు. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #FraudAlert #StaySafe/channels
...
```
📜 *CHANNEL RULES — 🚨 Fraud Alerts | మోసం జాగ్రత్త*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_alerts
...
```bash
python setup_channels.py --apply --key fraud_alerts
```
