...
- **Key:** `c_reddy_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** LIVE ✅
...
- **DP image:** `/home/user/shubhalagnam/backend/channel_assets/c_reddy_groom.png`
...
```
రెడ్డి — Reddy (Grooms). Sub-castes: Reddy • Pakanati Reddy • Motati Reddy • Gudati Reddy • Deshathi Reddy. నిజమైన profiles, 3 requests FREE, ₹99లో 5. Register FREE: manavivaha.in | Telegram: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #Reddy #Groom #TS #AP/channels
...
```
📜 *CHANNEL RULES — 🤵 Reddy Grooms | రెడ్డి వరులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_reddy_groom
...
```bash
python setup_channels.py --apply --key c_reddy_groom
```
