...
- **Key:** `c_kapu_bride`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** create ⬜
...
```
కాపు • బలిజ • తెలగ — Kapu • Balija • Telaga (Brides). Sub-castes: Kapu • Ontari • Turupu Kapu • Palli Kapu • Balija. నిజమైన profiles, 3 requests FREE, ₹99లో 5. Register FREE: manavivaha.in | Telegram: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #Kapu #Bride #TS #AP/channels
...
```
📜 *CHANNEL RULES — 👰 Kapu Brides | కాపు వధువులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_kapu_bride
...
```bash
python setup_channels.py --apply --key c_kapu_bride
```
