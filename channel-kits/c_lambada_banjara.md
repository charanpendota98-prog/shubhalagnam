...
- **Key:** `c_lambada_banjara`  •  **Tier:** L3_CASTE  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_lambada_banjara` (already taken? → @tsap_lambada_banjara, @manavivaha_lambada_banjara_community)
- **Link:** https://t.me/manavivaha_lambada_banjara
- **Hashtags:** #LambadaBanjara #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_lambada_banjara.png`
...
```
📜 *CHANNEL RULES — 💍 Lambada Banjara Matrimony | లంబాడ • బంజార వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_lambada_banjara
...
```bash
python setup_channels.py --apply --key c_lambada_banjara
```
