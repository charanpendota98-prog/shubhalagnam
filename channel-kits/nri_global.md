...
- **Key:** `nri_global`  •  **Tier:** L1_REGION  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_nri` (already taken? → @manavivaha_global, @manavivaha_usa)
- **Link:** https://t.me/manavivaha_nri
- **Hashtags:** #NRI #TeluguAbroad #GlobalTelugu
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/nri_global.png`
...
```
🌍 NRI Telugu Matrimony — విదేశీ సంబంధాలు. అన్ని కులాలు, అన్ని జిల్లాలు, రోజూ కొత్త profiles + గుణమేళనం వివరాలు. 3 FREE requests, ₹99లో 5. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #NRI #TeluguAbroad #GlobalTelugu/channels
...
```
📜 *CHANNEL RULES — 🌍 NRI Telugu Matrimony | విదేశీ సంబంధాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_nri
...
```bash
python setup_channels.py --apply --key nri_global
```
