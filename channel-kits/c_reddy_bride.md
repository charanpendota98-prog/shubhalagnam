...
- **Key:** `c_reddy_bride`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** LIVE ✅
...
```
రెడ్డి — Reddy (Brides). Sub-castes: Reddy • Pakanati Reddy • Motati Reddy • Gudati Reddy • Deshathi Reddy. నిజమైన profiles, 3 requests FREE, ₹99లో 5. Register FREE: manavivaha.in | Telegram: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #Reddy #Bride #TS #AP/channels
...
```
📜 *CHANNEL RULES — 👰 Reddy Brides | రెడ్డి వధువులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_reddy_bride
...
```bash
python setup_channels.py --apply --key c_reddy_bride
```
