...
- **Key:** `c_yadava_goud_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_yadava_goud_groom` (already taken? → @tsap_yadava_goud_groom, @mv_yadava_goud_grm)
- **Link:** https://t.me/manavivaha_yadava_goud_groom
- **Hashtags:** #YadavaGoud #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_yadava_goud_groom.png`
...
```
📜 *CHANNEL RULES — 🤵 Yadava Goud Grooms | యాదవ • గౌడ • గొల్ల వరులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_yadava_goud_groom
...
```bash
python setup_channels.py --apply --key c_yadava_goud_groom
```
