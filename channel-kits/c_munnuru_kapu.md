...
- **Key:** `c_munnuru_kapu`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_munnuru_kapu` (already taken? → @tsap_munnuru_kapu, @manavivaha_munnuru_kapu_community)
- **Link:** https://t.me/manavivaha_munnuru_kapu
- **Hashtags:** #MunnuruKapu #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_munnuru_kapu.png`
...
```
📜 *CHANNEL RULES — 💍 Munnuru Kapu Matrimony | మున్నూరు కాపు వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_munnuru_kapu
...
```bash
python setup_channels.py --apply --key c_munnuru_kapu
```
