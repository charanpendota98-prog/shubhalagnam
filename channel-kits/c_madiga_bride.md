...
- **Key:** `c_madiga_bride`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_madiga_bride` (already taken? → @tsap_madiga_bride, @mv_madiga_brd)
- **Link:** https://t.me/manavivaha_madiga_bride
- **Hashtags:** #Madiga #Bride #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_madiga_bride.png`
...
📢 Official: @TSAP_MATRIMONY | All channels: #Madiga #Bride #TS #AP/channels
...
```
📜 *CHANNEL RULES — 👰 Madiga Brides | మాదిగ వధువులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_madiga_bride
...
```bash
python setup_channels.py --apply --key c_madiga_bride
```
