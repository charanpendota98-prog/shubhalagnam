...
- **Key:** `c_viswabrahmana`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_viswabrahmana` (already taken? → @tsap_viswabrahmana, @manavivaha_viswabrahmana_community)
- **Link:** https://t.me/manavivaha_viswabrahmana
- **Hashtags:** #Viswabrahmana #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_viswabrahmana.png`
...
```
📜 *CHANNEL RULES — 💍 Viswabrahmana Matrimony | విశ్వబ్రహ్మణ వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_viswabrahmana
...
```bash
python setup_channels.py --apply --key c_viswabrahmana
```
