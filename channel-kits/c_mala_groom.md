...
- **Key:** `c_mala_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_mala_groom` (already taken? → @tsap_mala_groom, @mv_mala_grm)
- **Link:** https://t.me/manavivaha_mala_groom
- **Hashtags:** #Mala #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_mala_groom.png`
...
```
📜 *CHANNEL RULES — 🤵 Mala Grooms | మాల వరులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_mala_groom
...
```bash
python setup_channels.py --apply --key c_mala_groom
```
