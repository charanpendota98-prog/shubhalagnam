...
- **Key:** `c_madiga_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_madiga_groom` (already taken? → @tsap_madiga_groom, @mv_madiga_grm)
- **Link:** https://t.me/manavivaha_madiga_groom
- **Hashtags:** #Madiga #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_madiga_groom.png`
...
📢 Official: @TSAP_MATRIMONY | All channels: #Madiga #Groom #TS #AP/channels
...
```
📜 *CHANNEL RULES — 🤵 Madiga Grooms | మాదిగ వరులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_madiga_groom
...
```bash
python setup_channels.py --apply --key c_madiga_groom
```
