...
- **Key:** `doctors_teachers`  •  **Tier:** L4_SPECIAL  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_professionals` (already taken? → @manavivaha_doctors, @tsap_doctors, @manavivaha_teachers)
- **Link:** https://t.me/manavivaha_professionals
- **Hashtags:** #Doctors #Teachers #Healthcare
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/doctors_teachers.png`
...
```
🩺 Doctors & Teachers Matrimony — వైద్యులు + ఉపాధ్యాయులు. ఈ కేటగిరీ ప్రత్యేక profiles మాత్రమే — వేరే ఎక్కడా దొరకవు. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
```
📜 *CHANNEL RULES — 🩺 Doctors & Teachers Matrimony | వైద్యులు + ఉపాధ్యాయులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_professionals
...
```bash
python setup_channels.py --apply --key doctors_teachers
```
