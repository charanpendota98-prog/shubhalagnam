...
- **Key:** `christian_ts_groom`  •  **Tier:** L2_RELIGION  •  **Wave:** 1  •  **Status:** create ⬜
...
👉 Join: https://t.me/manavivaha_christian_ts_groom
...
```bash
python setup_channels.py --apply --key christian_ts_groom
```
