...
- **Key:** `c_others_sc`  •  **Tier:** L3_CASTE  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_others_sc` (already taken? → @tsap_others_sc, @manavivaha_others_sc_community)
- **Link:** https://t.me/manavivaha_others_sc
- **Hashtags:** #OthersSc #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_others_sc.png`
...
```
📜 *CHANNEL RULES — 💍 Others Sc Matrimony | ఇతర SC కులాలు వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_others_sc
...
```bash
python setup_channels.py --apply --key c_others_sc
```
