...
- **Key:** `c_yadava_goud_bride`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_yadava_goud_bride` (already taken? → @tsap_yadava_goud_bride, @mv_yadava_goud_brd)
- **Link:** https://t.me/manavivaha_yadava_goud_bride
- **Hashtags:** #YadavaGoud #Bride #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_yadava_goud_bride.png`
...
```
📜 *CHANNEL RULES — 👰 Yadava Goud Brides | యాదవ • గౌడ • గొల్ల వధువులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_yadava_goud_bride
...
```bash
python setup_channels.py --apply --key c_yadava_goud_bride
```
