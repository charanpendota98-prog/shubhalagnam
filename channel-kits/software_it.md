...
- **Key:** `software_it`  •  **Tier:** L4_SPECIAL  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_software` (already taken? → @tsap_software, @manavivaha_it)
- **Link:** https://t.me/manavivaha_software
- **Hashtags:** #Software #IT #Hyderabad
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/software_it.png`
...
```
💻 Software Matrimony — సాఫ్ట్‌వేర్ ఉద్యోగులు. ఈ కేటగిరీ ప్రత్యేక profiles మాత్రమే — వేరే ఎక్కడా దొరకవు. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #Software #IT #Hyderabad/channels
...
```
📜 *CHANNEL RULES — 💻 Software Matrimony | సాఫ్ట్‌వేర్ ఉద్యోగులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_software
...
```bash
python setup_channels.py --apply --key software_it
```
