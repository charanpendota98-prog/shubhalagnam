...
- **Key:** `c_raju_kshatriya`  •  **Tier:** L3_CASTE  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_raju_kshatriya` (already taken? → @tsap_raju_kshatriya, @manavivaha_raju_kshatriya_community)
- **Link:** https://t.me/manavivaha_raju_kshatriya
- **Hashtags:** #RajuKshatriya #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_raju_kshatriya.png`
...
```
📜 *CHANNEL RULES — 💍 Raju Kshatriya Matrimony | రాజు • క్షత్రియ వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_raju_kshatriya
...
```bash
python setup_channels.py --apply --key c_raju_kshatriya
```
