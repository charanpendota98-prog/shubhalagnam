...
- **Key:** `govt_jobs`  •  **Tier:** L4_SPECIAL  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_govt` (already taken? → @tsap_govt, @manavivaha_govtjobs)
- **Link:** https://t.me/manavivaha_govt
- **Hashtags:** #GovtJob #GovtTeacher
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/govt_jobs.png`
...
```
🏛️ Govt Jobs Matrimony — ప్రభుత్వ ఉద్యోగులు. ఈ కేటగిరీ ప్రత్యేక profiles మాత్రమే — వేరే ఎక్కడా దొరకవు. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
```
📜 *CHANNEL RULES — 🏛️ Govt Jobs Matrimony | ప్రభుత్వ ఉద్యోగులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_govt
...
```bash
python setup_channels.py --apply --key govt_jobs
```
