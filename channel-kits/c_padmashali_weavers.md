...
- **Key:** `c_padmashali_weavers`  •  **Tier:** L3_CASTE  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_padmashali_weavers` (already taken? → @tsap_padmashali_weavers, @manavivaha_padmashali_weavers_community)
- **Link:** https://t.me/manavivaha_padmashali_weavers
- **Hashtags:** #PadmashaliWeavers #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_padmashali_weavers.png`
...
```
📜 *CHANNEL RULES — 💍 Padmashali Weavers Matrimony | పద్మశాలి • దేవాంగ వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_padmashali_weavers
...
```bash
python setup_channels.py --apply --key c_padmashali_weavers
```
