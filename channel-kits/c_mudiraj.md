...
- **Key:** `c_mudiraj`  •  **Tier:** L3_CASTE  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_mudiraj` (already taken? → @tsap_mudiraj, @manavivaha_mudiraj_community)
- **Link:** https://t.me/manavivaha_mudiraj
- **Hashtags:** #Mudiraj #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_mudiraj.png`
...
```
📜 *CHANNEL RULES — 💍 Mudiraj Matrimony | ముదిరాజ • తెనుగొల్ల వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_mudiraj
...
```bash
python setup_channels.py --apply --key c_mudiraj
```
