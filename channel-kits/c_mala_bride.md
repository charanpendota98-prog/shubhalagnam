...
- **Key:** `c_mala_bride`  •  **Tier:** L3_CASTE  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_mala_bride` (already taken? → @tsap_mala_bride, @mv_mala_brd)
- **Link:** https://t.me/manavivaha_mala_bride
- **Hashtags:** #Mala #Bride #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_mala_bride.png`
...
```
📜 *CHANNEL RULES — 👰 Mala Brides | మాల వధువులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_mala_bride
...
```bash
python setup_channels.py --apply --key c_mala_bride
```
