...
- **Key:** `other_religion`  •  **Tier:** L2_RELIGION  •  **Wave:** 2  •  **Status:** create ⬜
- **Username:** `@manavivaha_other_religions` (already taken? → @manavivaha_others, @manavivaha_minority)
- **Link:** https://t.me/manavivaha_other_religions
- **Hashtags:** #OtherReligions #Respect
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/other_religion.png`
...
```
🕊️ Other Religions — ఇతర మత వివాహాలు. వధువులు + వరులు, అన్ని జిల్లాలు. 3 FREE requests, ₹99లో 5. Register FREE: manavivaha.in | Bot: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #OtherReligions #Respect/channels
...
```
📜 *CHANNEL RULES — 🕊️ Other Religions | ఇతర మత వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_other_religions
...
```bash
python setup_channels.py --apply --key other_religion
```
