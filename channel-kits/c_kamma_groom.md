...
- **Key:** `c_kamma_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** LIVE ✅
...
```
కమ్మ — Kamma (Grooms). Sub-castes: Kamma • Chowdary • Choudary. నిజమైన profiles, 3 requests FREE, ₹99లో 5. Register FREE: manavivaha.in | Telegram: @telugumatrimony1_bot
```
...
📢 Official: @TSAP_MATRIMONY | All channels: #Kamma #Groom #TS #AP/channels
...
```
📜 *CHANNEL RULES — 🤵 Kamma Grooms | కమ్మ వరులు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_kamma_groom
...
```bash
python setup_channels.py --apply --key c_kamma_groom
```
