...
- **Key:** `c_kapu_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** LIVE ✅
...
- **DP image:** `/home/user/shubhalagnam/backend/channel_assets/c_kapu_groom.png`
...
```
కాపు • బలిజ • తెలగ — Kapu • Balija • Telaga (Grooms). Sub-castes: Kapu • Ontari • Turupu Kapu • Palli Kapu • Balija. నిజమైన profiles, 3 requests FREE, ₹99లో 5. Register FREE: manavivaha.in | Telegram: @telugumatrimony1_bot
```
